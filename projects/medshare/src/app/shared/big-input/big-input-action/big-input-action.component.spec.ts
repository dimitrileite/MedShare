...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<mds-big-input-action></mds-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<mds-big-input-action [disabled]="true"></mds-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<mds-big-input-action fontSet="fas" fontIcon="fa-trash"></mds-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<mds-big-input-action label="delete"></mds-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<mds-big-input-action (action)="actionHandler()"></mds-big-input-action>';
    fixture = createHostComponent(template);
