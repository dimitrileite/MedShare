...
we use the git commit messages to **generate the [change log](https://github.com/tomastrajan/medshare/blob/master/CHANGELOG.md)**.
...
Even more [examples](https://github.com/tomastrajan/medshare/commits/master) of commit messages from commit history of this project.
